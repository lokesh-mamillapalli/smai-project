# Handwritten Kannada Digit Recognizer 🖌️
...
- **In-Browser Inference:** Powered by `onnxruntime-web` / `TensorFlow.js`, the neural network executes locally on your machine, ensuring data privacy and lighting-fast results.
...
1. **Educational Apps:**  
   The interactive canvas and "Practice Mode" act as a perfect educational suite. Students learning the Kannada script can practice writing specific numerals and instantly see if their stroke order and structure are legible to native readers.
